...
export default function AdNavBar() {
  ...
  return (
    <header>
      <div className='fixed left-0 top-0 z-50 flex min-h-[58px] w-full items-center border-b-[1px] bg-white shadow-sm xs:border-b-2 xs:px-4'>
        <div className='flex h-full w-full items-center justify-between mx-2 '>
          {/* 홈 버튼 */}
          <HomeButton />
